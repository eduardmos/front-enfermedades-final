    ...
    <div className="footer-box">
      {showfirst ? (
        ...
        <div>
          ...
          <p className="footer-box-content">
      ...
      {showsecond ? (
        <div>
          <h4 className="footer-box-title">¿El Alzheimer es hereditario?</h4>
        </div>
      ) : (
        <div>
          <h4 className="footer-box-title">¿El Alzheimer es hereditario?</h4>
      ...
      {showthird ? (
        <div>
          <h4 className="footer-box-title">¿Cual es la causa del Parkinson?</h4>
        </div>
      ) : (
        <div>
          <h4 className="footer-box-title">¿Cual es la causa del Parkinson?</h4>
      ...
      {showfourth ? (
        <div>
          <h4 className="footer-box-title">
            ¿Qué diferencias hay entre la ELA y la EM?
          </h4>
        </div>
      ) : (
        <div>
